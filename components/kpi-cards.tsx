      ...
      <div className="grid grid-cols-4 gap-6">
        {cards.map((card, idx) => {
          ...
          return (
            <div
              key={idx}
              className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm hover:shadow-lg hover:border-slate-300 transition-all duration-300 hover:-translate-y-1"
            >
